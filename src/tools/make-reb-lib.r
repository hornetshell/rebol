...
#if __x86_64__
#define SIZE_REBREQ 100
#define SIZE_REBEVT 16
#else
#define SIZE_REBREQ 800
#define SIZE_REBEVT 12
#endif

#define CHECK_STRUCT_ALIGN (sizeof(REBREQ) == SIZE_REBREQ && sizeof(REBEVT) == SIZE_REBEVT)
